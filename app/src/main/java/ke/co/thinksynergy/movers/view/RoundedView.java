package ke.co.thinksynergy.movers.view;
...
public class RoundedView extends View {
    ...
    public RoundedView(Context context, AttributeSet attrs) {
        ...
        uncheckedColor = a.getColor(R.styleable.RoundedView_colorUnselected,
                ContextCompat.getColor(getContext(), android.R.color.darker_gray));
        checkedColor = a.getColor(R.styleable.RoundedView_colorSelected,
